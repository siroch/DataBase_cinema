...
exports.timetable = (req, res) => {
  return new Promise((resolve,reject)=>{
    ...
    const data=[];
    const sql=`select screen_num,show_time,show_date from time_table where theater_id='${theater_id}' and movie_id='${movie_id}' and DATE(show_date)='${dates[0]}-${dates[1]}-${dates[2]}' and show_date>=NOW()`
